...
App({
  onLaunch: function() {
    ...
    WXAPI.queryConfigBatch('mallName,comName,share_profile,website_0,website_1,wifi,kefu_corpId,kefu_url,qiyeweixin_open,wexin_plugid,wexin_url,online_pay,quhao,show_copyright').then(res => {
      if (res.code == 0) {
